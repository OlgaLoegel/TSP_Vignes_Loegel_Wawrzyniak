...
public class MotorSix {
	 ...
	 */
	public MotorSix(int m, double alpha, double beta, double p, int Q, double evaporation, Instance instance, long timeLimit) {
	...
	public void motor()  {
		...
		while (spentTime < (m_timeLimit * 1000 - 100) && !sameWay) {
            ...
            System.out.println("Pheromones voyons voir"+Arrays.deepToString(pher));
